...
- Bad :: It will be a long time before any new features can be brought
  to the user
- Bad :: The bigger the deployment the bigger the risk
- Bad :: Big UI changes for the user, which means large training
  efforts
