...
(defn write-global-tables []
  (write-global-table 1 {} (db/get-global-words-with-braille {:braille "uncontracted"}))
  (write-global-table 2 {} (db/get-global-words-with-braille {:braille "contracted" :types [0 1 3 5]}))
  (write-global-table 2 {:name? true} (db/get-global-words-with-braille {:braille "contracted" :types [1 2]}))
  (write-global-table 2 {:place? true} (db/get-global-words-with-braille {:braille "contracted" :types [3 4]})))
...
(defn export-local-tables [document-id]
  ...
  (let [document (db/get-document {:id document-id})]
    (write-local-tables document (db/get-local-words {:id document-id :grade 0}))))
